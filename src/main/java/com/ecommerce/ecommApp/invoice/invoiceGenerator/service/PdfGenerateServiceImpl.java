...
public class PdfGenerateServiceImpl implements PdfGenerateService {
     ...
     *
     * @param headerFooterServiceImpl object for initialize the local variable
     */
    @Autowired
    public PdfGenerateServiceImpl(HeaderFooterServiceImpl headerFooterServiceImpl) {
        this.headerFooterServiceImpl = headerFooterServiceImpl;
    }
    ...
    public String generatePdf(InvoiceFormatDto invoiceFormatDto) {
        ...
        try {
            ...
            headerFooterServiceImpl.setHeader(invoiceFormatDto.getTitle());
            pdfWriter.setPageEvent(headerFooterServiceImpl);
